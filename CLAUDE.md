...
- **팩터 투자 프레임워크** (Value/Momentum/Quality/LowVol/Size z-score) — 레거시/팩터/블렌드 3모드
- **포지션 사이징** (ERC/Vol Target/Half-Kelly) + 리스크 제약 + 드로다운 관리
...
| 환경변수      | python-dotenv                   |                                                      |
| 테스트        | pytest, pytest-cov              | 946개 테스트, 87개 테스트 파일                       |
...
│   │   ├── position_sizer.py    # 포지션 사이징 (ERC/Vol Target/Half-Kelly + AI 신뢰도 틸트)
